    ...
    internal class Helper : MonoBehaviourPunCallbacks
    {
        ...
        public void MagicMonkey()
        {
            ...
            if (Input.RightTrigger && Input.RightGrip)
            {
                ...
                Camera.main.transform.position = Vector3.MoveTowards(Camera.main.transform.position, pointer.transform.position, step);
        ...
        public void KickGun()
        {
            if (Input.RightGrip)
            {
                ...
                if (Input.RightTrigger && KickPlayer != null)
                {
                    ...
                    PhotonView Photonview = GetPhotonViewFromRig(KickPlayer);
                    Photon.Realtime.Player owner = Photonview.Owner;
                    if (Photonview != null || owner != null)
                    {
                        if (Time.time > KickG + 0.85f)
                        {
                            if (DoOnceKick)
                            {
        ...
        public void LagGun()
        {
            if (Input.RightGrip)
            {
                ...
                if (Input.RightTrigger && lagrig != null)
                {
                    ...
                    PhotonView Photonview = GetPhotonViewFromRig(lagrig);
                    Photon.Realtime.Player owner = Photonview.Owner;
                    if (Photonview != null || owner != null)
                    {
        ...
        {
            while (Plugin.buttonsActive[44] == true)
            {
